...
| 20 | S20 | C3 State badge renderer | Reusable `StateBadge` widget/icon rendering color-coded state with legend | Badge renders correct color/icon; reusable; legend present | Qt widget test: badge rendering per state | C2 | S | ASSIGNED |
