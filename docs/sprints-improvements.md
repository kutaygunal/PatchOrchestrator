...
| 17 | S17 | B7 Control action feedback | Control panel shows live confirmation engine actually paused/resumed/rolled back (state diff before/after) | Panel shows before/after state diff; confirmation visible | Qt integration test: state diff displayed | B3, B6 | M | ASSIGNED |
