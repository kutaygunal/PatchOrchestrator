#!/usr/bin/env bash
#
# Phase 9 verification runner (scrum-master authored).
# Builds the Qt schedule-editor target `patchorchestrator_schedule_ui`,
# confirms it links, and runs an offscreen smoke check.
#
...
BUILD_DIR="${PROJECT_ROOT}/build.p9"
LOG_DIR="${BUILD_DIR}"
mkdir -p "${LOG_DIR}"
TARGET="patchorchestrator_schedule_ui"
EXE_NAME="patchorchestrator_schedule_ui"
