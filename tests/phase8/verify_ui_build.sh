#!/usr/bin/env bash
#
# Phase 8 verification runner (scrum-master authored).
# Builds the Qt dashboard target `patchorchestrator_ui`, confirms it links,
# and runs an offscreen smoke check.
#
...
BUILD_DIR="${PROJECT_ROOT}/build.p8"
LOG_DIR="${BUILD_DIR}"
mkdir -p "${LOG_DIR}"
TARGET="patchorchestrator_ui"
EXE_NAME="patchorchestrator_ui"
